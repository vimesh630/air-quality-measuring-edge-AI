...
// ── Stat card ────────────────────────────────────────────────
const StatCard = ({ label, value, accent, icon: Icon, darkMode = true }) => (
  <div
    ...
    onMouseEnter={e => {
      ...
      e.currentTarget.style.boxShadow   = darkMode 
        ? `var(--shadow-card), 0 0 18px ${accent || 'rgba(41,121,255,0.2)'}44`
  ...
  >
    ...
    <div style={{
      ...
      lineHeight: 1,
      marginBottom: 6,
      textShadow: accent && darkMode ? `0 0 20px ${accent}55` : 'none'
    }}>
      {value ?? '—'}
    </div>
    <div style={{
          ...
          <>
            ...
            {tab === 'overview' && (
              <>
                ...
                >
                  <StatCard label="Total Readings" value={stats?.total} darkMode={darkMode} />
                  <StatCard label="Total Alerts"   value={stats?.alerts}             accent="var(--red)" darkMode={darkMode} />
                  <StatCard label="Average AQI"    value={stats?.avg_aqi}            accent="var(--blue-bright)" darkMode={darkMode} />
                  <StatCard label="Good Readings"  value={stats?.label_counts?.good} accent="var(--green)" darkMode={darkMode} />
                </div>
                ...
                >
                  ...
                  <DeviceControl darkMode={darkMode} />
                </div>
            ...
            {tab === 'analytics' && (
              <>
                ...
                <div style={{ marginBottom: 16 }}>
                  <AQIForecast forecast={forecast} darkMode={darkMode} />
                </div>
