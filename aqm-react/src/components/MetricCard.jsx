...
export default function MetricCard({ label, value, unit, accent, sublabel, raw }) {
  ...
  return (
    <div
      ...
      onMouseEnter={e => {
        ...
        e.currentTarget.style.boxShadow   = `var(--shadow-card), 0 0 20px ${accent || 'rgba(41,121,255,0.15)'}66`
      }}
      onMouseLeave={e => {
    ...
    >
      ...
      <div style={{
        ...
        width: 80, height: 80,
        background: `radial-gradient(circle at top right, ${accent || 'var(--blue)'}15, transparent 70%)`,
